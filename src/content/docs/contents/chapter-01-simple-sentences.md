...
所谓「限定动词」，就是会随人称、时态的不同而产生变化的动词（例如主词是第三人称单数时，限定动词的现在时要加-s）。传统语法所谓的动词，指的都是限定动词。至于**非限定动词（nonfinite verb）**&#8203;，传统语法并不视为动词看待，而是称为**动状词（verbals）**&#8203;，包括现在分词、过去分词、动名词、不定词短语等等。必须要有限定动词，才能构成一个独立的句子或是限定子句。
