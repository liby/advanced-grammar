...
例 1 中的 used to 是个次要的语气助动词，表示「过去的习惯」，所以它只有过去时。在语气助动词后面要用原形动词，所以正确的说法是 used to walk。例 2 中的 used 是过去分词、属于形容词类，当主语补语使用，意思是「习惯了」，它后面的 to 是介词，用来说明「对什么事情」习惯了。介词后面要接名词当宾语，例如可以说 I am used to long walks。如果介词后面碰到动词，要改为动状词的话就只能选择动名词，如 I am used to walking…。
