...
export default async function Page(props: PageProps) {
  ...
  return (
    <DocsPage
      toc={page.data.toc}
      // On heading-less pages, keep the rail/popover for the footer links but
      // hide the built-in "本页目录" title and empty list (not prop-removable).
      tableOfContent={{
        footer: actions,
        ...(hasToc
          ? {}
          : {
              container: {
                className: '[&>#toc-title]:hidden [&>#toc-title+div]:hidden'
              }
            })
      }}
      tableOfContentPopover={{
        ...
        ...(hasToc
          ? {}
          : { content: { className: '[&>div:first-child]:hidden' } })
      }}
    >
